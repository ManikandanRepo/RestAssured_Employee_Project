...
public class TC002_Post_Create_Employee extends TestBase{
	
	public HashMap<String, String> reqBody = new HashMap<>();
	
	@BeforeClass
	public void createEmployee() throws InterruptedException {
		logger.info("*****Started TC002_Post_Create_Employee**********");
	...
	public void tearDown() {
		logger.info("************Test case TC002_Post_Create_Employee is completed************");
	}
